...
def baca_data(nama_file):
    ...
    with open(nama_file, 'r') as file:
        for baris in file:
            ...
            data_dict[nim] = {'nama': nama, 'nilai': int(nilai)} #memasukkan dalam dictionary
    return data_dict

buka_data = baca_data(nama_file)
#print("junlah data terbaca: ", len(buka_data))
...
def tampilkan_data(data_dict):
    ...
    {'NIM': <10} artinya nim rata kir dengan lebar kolom 10 karakter
    {'Nama': <12} artinya nama rata kiri dengan lebar kolom 12 karakter
    {'Nilai': >5} artinya nilai rata kanan lebar kolom 5 karakter
    '''
...
#membuat fungsi menyimmpan data ke File
...
def main():
    #Load data otomatais saat program dimulai
    buka_data = baca_data(nama_file) #fs. fungsi load data

    while True:
        print("\n=== MENU DATA MAHASISWA ===")
        print("1. Tampilkan Data Mahasiswa")
        print("2. Cari Data Mahasiswa")
        print("3. Ubah Nilah Mahasiswa")
